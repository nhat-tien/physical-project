  ...
  return (
    ...
    url(${bg.src})`}}>
        <div className='absolute sm:top-36 sm:left-52 max-w-md p-3 top-10 '>
          ...
          <button className='sm:w-2/4 w-full mt-5 rounded-md block text-heavy-blue bg-orange px-5 py-2 text-lg font-medium transition ease-in-out delay-150 hover:translate-x-1 hover:scale-105 '><a href='#document'>Khám phá ngay <Image src='/arrow.svg' width={30} height={30} className='inline'></Image></a></button>
        </div>
      </section>
